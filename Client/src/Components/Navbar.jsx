          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              ...
              <div className="relative group">
                ...
                {/* Dropdown */}
                <div className="absolute left-0 bg-slate-800 shadow-lg rounded-lg w-48 opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none group-hover:pointer-events-auto">
                  <NavLink
                    to="/trademark"
                    className="block px-4 py-2 hover:bg-slate-800 text-white hover:text-gray-300"
                  >
                    Trademark
                  </NavLink>
                  <NavLink
